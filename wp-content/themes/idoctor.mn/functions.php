...
function html5blank_header_scripts()
{
    ...
    /*	wp_register_script('conditionizr', get_template_directory_uri() . '/js/lib/conditionizr-4.3.0.min.js', array(), '4.3.0'); // Conditionizr
        ...
        wp_register_script('modernizr', get_template_directory_uri() . '/js/vendor/modernizr-3.6.0.min.js', array(), '2.7.1'); // Modernizr
        wp_enqueue_script('modernizr'); // Enqueue it!

        wp_register_script('swiperjs', get_template_directory_uri() . '/js/swiper/js/swiper.min.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('swiperjs'); // Enqueue it!
...
function html5blank_conditional_scripts()
{
    ...
    if(is_single()) {
         wp_register_style('photoswipecss', get_template_directory_uri() . '/js/photoswiper/photoswipe.css', array(), '1.0', 'all');
        wp_enqueue_style('photoswipecss'); // Enqueue it!

        wp_register_style('default-skin', get_template_directory_uri() . '/js/photoswiper/default-skin/default-skin.css', array(), '1.0', 'all');
        wp_enqueue_style('default-skin'); // Enqueue it!

        wp_register_script('photoswipejs', get_template_directory_uri() . '/js/photoswiper/photoswipe.min.js', array(), '1.0.0', true); // Conditional script(s)
        wp_enqueue_script('photoswipejs'); // Enqueue it!
...
function html5blank_styles()
{
    ...
    wp_register_style('swipercss', get_template_directory_uri() . '/js/swiper/css/swiper.css', array(), '1.0', 'all');
    wp_enqueue_style('swipercss'); // Enqueue it!

    wp_register_style('bulma', get_template_directory_uri() . '/css/bulma.min.css', array(), '1.0', 'all');
    ...
    wp_register_style('main', get_template_directory_uri() . '/css/main.css', array(), '2.2', 'all');
